...
//         <NavLink to='/'> <img src='images/nikah_logo.png'/></NavLink>                  
//       </div>
...
//               Articles
//           </NavLink>
//             <NavLink to="/kabin_notary" onClick={toggleMenu}>
//             Kabin Notary
//             </NavLink>
//           <NavLink to="/nikah_essentials" className='nikah-essentials' onClick={toggleMenu}>
//               Nikah Essentials
//             </NavLink>
...
function Navbar() {
  ...
  return (
    ...
    <div className={`login-signup ${isMenuOpen ? 'open' : ''}`}>
        {isAuthenticated ? (
          <>
            <NavLink to="/user_profile" className='username' onClick={toggleMenu}>~{user.name}~ </NavLink>
            <NavLink to="/logout" className='logout'   onClick={() => logout({ logoutParams: { returnTo: window.location.origin } })}>Logout</NavLink>
          </>
        ) : (
          <>
            <NavLink to="/login"  onClick={() => loginWithRedirect()}>Login</NavLink>
